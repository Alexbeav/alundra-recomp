# Alundra knowledge report

- Date: 2026-08-31
- Retail identity: Europe PAL `SLES-01135`
...
The source now uses `Alundra_Recompiled` as the only setup executable name. The batch source
