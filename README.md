...
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/alundra-recomp/total)](https://github.com/Alexbeav/alundra-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/alundra-recomp/latest/total)](https://github.com/Alexbeav/alundra-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/alundra-recomp)](https://github.com/Alexbeav/alundra-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Alundra** built on
[psxrecomp](https://github.com/Alexbeav/psxrecomp) and
[recomp-ui](https://github.com/mstan/recomp-ui).

A native recompilation setup host for Alundra.
...
Zip prefix for CI artifacts: `Alundra-Recomp`.
...
The `v0.3.3` source uses `Alundra_Recompiled` in CMake, the setup relaunch, and the packager.
